...
import longho.nienluan.traicayngoainhap.View.HienThiTraiCayTheoDanhMuc.HienThiTraiCayTheoLoaiActivity;
    ...
    public void onBindViewHolder(@NonNull final RecyclerViewHolder holder, int position) {
        ...
        holder.lnLoaiTraiCay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent iHienThiTraiCayTheoDanhMuc = new Intent(context,HienThiTraiCayTheoLoaiActivity.class);
