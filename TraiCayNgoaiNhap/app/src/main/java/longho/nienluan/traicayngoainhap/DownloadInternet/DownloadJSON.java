package longho.nienluan.traicayngoainhap.DownloadInternet;
...
public class DownloadJSON extends AsyncTask<String, Void, String> {
    ...
    //dùng cho phương thức GET
    public DownloadJSON(String duongdan){
        this.duongdan = duongdan;
        method = true;
    }

    //dùng cho phương thức POST
    ...
    protected String doInBackground(String... strings) {
        ...
        try {
            ...
            if(!method){ //đếm giá trị nhận vào nếu có giá trị gọi POST ngược lại gọi GET
