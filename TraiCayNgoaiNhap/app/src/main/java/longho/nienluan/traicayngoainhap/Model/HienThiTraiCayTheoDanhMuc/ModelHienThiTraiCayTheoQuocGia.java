...
public class ModelHienThiTraiCayTheoQuocGia {
    public List<traicay> LayDanhSachTraiCayTheoQuocGia(int MaQG){
        ...
        hsHam.put("ham","LayDanhSachTraiCayTheoQuocGia");
        HashMap<String,String> hsMaQG = new HashMap<>();
        hsMaQG.put("maqg", String.valueOf(MaQG));
