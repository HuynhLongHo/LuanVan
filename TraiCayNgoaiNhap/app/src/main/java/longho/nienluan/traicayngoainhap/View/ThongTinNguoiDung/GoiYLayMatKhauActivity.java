...
public class GoiYLayMatKhauActivity extends AppCompatActivity implements ViewThongTinNguoiDung,View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_goiylaymatkhau);
    ...
    public boolean kiemtrathongtin(){
        ...
        if(cauhoi.trim().length()==0){
            input_edCauHoi.setError("Chưa nhập gợi ý");
        ...
        if(cautraloi.trim().length()==0){
            input_edCauTraLoi.setError("Chưa nhập câu trả lời");
            edHoTen.requestFocus();
            kiemtra &= false;
        }else{
